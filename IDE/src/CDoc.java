...
public class CDoc implements DocumentListener
{
	...
	private String[][] keyWordStr = {{"auto", "bool", "char", "class", "double", "enum", "export", "extern", "float", "friend", "inline", "int", "long", "register", "short", "struct", "template", "typename", "union", "void", "wchar_t",
								      "const", "mutable", "private", "protected", "public", "signed", "static", "unsigned", "virtual", "volatile",
									  "asm",
								      "explicit"},
								     {"dynamic_cast", "false", "namespace", "reinterpret_cast", "true", "typedef", "using",
								      "const_cast", "static_cast",
								      "break", "case", "catch", "continue", "default", "do", "else", "for", "goto", "if", "return", "switch", "throw", "try", "while",
								      "delete", "new", "this", "typeid",
								      "and", "and_eq", "bitand", "bitor", "compl", "not", "not_eq", "operator", "or", "or_eq", "sizeof", "xor", "xor_eq"}};
	...
	{	
		complete = false;
		arr.clear();
		SwingUtilities.invokeLater(new ColoringC(this.pane, arr, this));

...
public class PDoc implements DocumentListener
{
	...
	private String[][] keyWordStr = {{"False", "None", "True",
								      "class", "def",
									  "as", "assert", "break", "continue", "del", "elif", "else", "except", "finally", "for", "global", "if", "pass", "raise", "return", "try", "while", "with", "yield",
									  "and", "not", "or", "is", "in", "lambda",
									  "from", "import"},
								     {"nonlocal"}};
	...
	{	
		complete = false;
		arr.clear();
		SwingUtilities.invokeLater(new ColoringP(this.pane, arr, this));
